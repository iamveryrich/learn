...
public class BinaryTree {
  ...
  /**
   * 深度优先遍历，相当于先根遍历 采用递归实现
   */
  public void dfsWithRecur(TreeNode root) {
    if (root == null) {
      return;
    }
    //前序遍历
    System.out.print(root.value + " ");
    dfsWithRecur(root.left);
    dfsWithRecur(root.right);
  }
